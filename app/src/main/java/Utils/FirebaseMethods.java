...
public class FirebaseMethods {
        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(mContext, "Wohoo!!Photo upload success", Toast.LENGTH_SHORT).show();
                    // add the new photo to 'photos' node and 'user_photos' node
                    addPhotoToDatabase(caption,firebaseUrl.toString());
                    //navigate to main feed so user can see his/her photo
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(mContext, "Alas!!photo upload failed", Toast.LENGTH_SHORT).show();
                }
    ...
    public void updateUserAccountSettings(String displayName,String website,String description,long phoneNumber) {
        Log.d(TAG, "changeUserAccountSettings: updating user account settings");
        if (displayName != null) {
            myRef.child(mContext.getString(R.string.dbname_user_account_settings))
                    .child(userID)
    ...
    public void updateUsername(String username){
        Log.d(TAG, "updateUsername: Updatinn username to: " + username);
...
//            Log.d(TAG, "checkIfUsernameExists: datasmapshot" + ds);
//
...
//    }
     ...
     * Add information to the users_accounnt_Settings node
     * @param email
     * @param username
     * @param description
     * @param website
