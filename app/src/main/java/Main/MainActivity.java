...
public class MainActivity extends AppCompatActivity implements MainfeedListAdapter.OnLoadMoreItemsListener {
    ...
    public void onLoadMoreItems() {
        ...
        HomeFragment fragment = (HomeFragment) getSupportFragmentManager().findFragmentByTag("android:switcher" +
                R.id.viewpager_container + ":" + mViewPager.getCurrentItem());
        if(fragment != null){
    ...
    private void setupViewPager(){
        ...
        tabLayout.getTabAt(0).setIcon(R.drawable.ic_instalogo);
    }
